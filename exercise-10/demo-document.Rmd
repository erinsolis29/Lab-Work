...
# just need to change it to the other style that we have in the csl thing
...
#can save the graph from python and use markdown to import and show the image after the code
